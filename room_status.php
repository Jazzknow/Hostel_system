            ...
            <div class="box-info-container">
                ...
                <div class="horizontal-box" style="width: 100%; margin-top: -15px;">
                    <table id="bookingTable">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT photo, roomnumber, bedtype, roomcapacity, roomprice,  status FROM add_room_management";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                                <a href='reservation_room.php' style='background: #007bff; color: white; padding: 5px 10px; border-radius: 5px; text-decoration: none;'>Book Now</a>
                                            </td>
                                        </tr>
                                            </td>";
                                    echo "</tr>";
