...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2024 at 03:14 PM
...
INSERT INTO `room_reservation` (`room_id`, `fullname`, `email`, `address`, `phonenumber`, `Totalguest`, `guestimage`, `roomtype`, `roomnumber`, `checkin`, `checkout`, `num_days`, `arrival_time`, `amenities`, `status`, `accompany`, `departure_time`) VALUES
(41, 'Juan Dela Cruz De Guzman', 'JuanDelaCruz@gmail.com', 'Rosario', '944555', 2, 'Screenshot 2024-09-09 193000.png', 'Standard Room', '203', '2024-09-12', '2024-09-13', 1, '08:45:00', 'wifi', 'checkin', 'anything, anything, anything', '02:45:00'),
(42, 'Juan Dela Cruz De Guzman', 'JuanDelaCruz@gmail.com', 'Rosario', '944555', 2, 'Screenshot 2024-09-09 193000.png', 'VIP Room', '205', '2024-09-13', '2024-09-14', 1, '08:54:00', 'parking', 'checkin', 'anything, anything, anything', '05:54:00');
...
--
ALTER TABLE `room_reservation`
  MODIFY `room_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
